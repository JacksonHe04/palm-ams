// src/admin/services/apply.service.ts
...
export class ApplyService {
  ...
  return applies.map(apply => ({
    ...
    awards: [
      {
        isLeader: apply.award1_isLeader !== undefined ? apply.award1_isLeader : null,
      ...
      {
        isLeader: apply.award2_isLeader !== undefined ? apply.award2_isLeader : null,
      ...
      {
        isLeader: apply.award3_isLeader !== undefined ? apply.award3_isLeader : null,
