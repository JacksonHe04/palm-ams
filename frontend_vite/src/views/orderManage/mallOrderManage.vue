...
<script>
    import shoppingMallOrderDetail from "@/views/orderManage/components/shoppingMallOrderDetail.vue";
    import deliverGoodsModule from "@/views/orderManage/components/deliverGoodsModule.vue";
